...
class _EmptyExecutiveKnowledge:
...
class ProjectIntelligenceService:
    ...
    def __init__(
        ...
        self.strategic_context_service = strategic_context_service or StrategicContextService(
            project_service, _EmptyExecutiveKnowledge()
        )
    ...
    def fetch_project_intelligence(self, project_id: str) -> ProjectIntelligence | None:
        ...
        if strategic_context is None:
            raise RuntimeError(f"Strategic context project '{project.project_id}' was not found.")
